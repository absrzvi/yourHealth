...
class EDI837Generator {
    constructor(customConfig) {
        ...
        this.controlNumber = (0, mapper_1.generateControlNumber)();
        const now = new Date();
        this.transactionDate = (0, utils_1.formatEDIDate)(now);
        this.transactionTime = (0, utils_1.formatEDITime)(now);
    }
    generateFromClaim(claim) {
        this.segments = [];
        this.segmentCount = 0;
    ...
    addISA() {
        ...
        this.addSegment([
            ...
            (0, utils_1.padRight)(this.config.senderId, 15),
            this.config.receiverQualifier || "ZZ",
            (0, utils_1.padRight)(this.config.receiverId, 15),
            dateStr,
            timeStr,
            "^",
            "00501",
    ...
    addSubmitterName() {
        ...
        this.addSegment([
            ...
            "41",
            "2",
            (0, utils_1.formatEDIName)(orgName),
            "",
            "",
            "",
            "",
    ...
    addSubscriber(claim) {
        ...
        const nameInfo = (0, utils_1.parsePersonName)(user.name);
        this.addSegment([
            "NM1", // Name segment
            "IL", // Insured or Subscriber
            "1", // Person
            (0, utils_1.formatEDIName)(nameInfo.lastName) || "DOE", // Last name
            (0, utils_1.formatEDIName)(nameInfo.firstName) || "JOHN", // First name
            (0, utils_1.formatEDIName)(nameInfo.middleName) || "", // Middle name
            "", // Name prefix
            "", // Name suffix
    ...
    addPatient(claim) {
        ...
        if (!patientIsSubscriber) {
            ...
            const nameInfo = (0, utils_1.parsePersonName)(patient.name);
            this.addSegment([
                "NM1",
                "QC", // Patient
                "1", // Person
                (0, utils_1.formatEDIName)(nameInfo.lastName) || "DOE", // Last name
                (0, utils_1.formatEDIName)(nameInfo.firstName) || "JANE", // First name
                (0, utils_1.formatEDIName)(nameInfo.middleName) || "", // Middle name
                "", // Name prefix
                "", // Name suffix
    ...
    addClaimInformation(claim) {
        ...
        this.addSegment([
            "CLM",
            claim.claimNumber,
            (0, utils_1.formatEDIAmount)(claim.totalCharge),
            "", // Not used
            "", // Not used
        ...
        const serviceDate = claim.serviceDate ? (0, utils_1.formatEDIDate)(claim.serviceDate) : (0, utils_1.formatEDIDate)(new Date());
        this.addSegment([
            "DTP",
            "472", // Service Date
            "D8", // Date format
        ...
        if (claim.onsetDate) {
            this.addSegment([
                ...
                "431", // Onset Date
                "D8", // Date format
                (0, utils_1.formatEDIDate)(claim.onsetDate)
            ]);
        }
        // Add diagnosis codes
        ...
        if (this.config.serviceFacility && this.config.serviceFacility.npi) {
            ...
            this.addSegment([
                ...
                "77", // Service Facility
                "2", // Non-Person
                (0, utils_1.formatEDIName)(this.config.serviceFacility.name), // Facility Name
                "", // Not used for non-person
                "", // Not used for non-person
                "", // Not used for non-person
                "", // Not used for non-person
            ...
            this.addSegment([
                "N3",
                (0, utils_1.formatEDIName)(this.config.serviceFacility.address1),
                this.config.serviceFacility.address2 || ""
            ]);
            this.addSegment([
                "N4",
                (0, utils_1.formatEDIName)(this.config.serviceFacility.city),
                this.config.serviceFacility.state,
                this.config.serviceFacility.zip
            ]);
        }
    }
    addServiceLines(claim) {
        if (claim.claimLines && Array.isArray(claim.claimLines)) {
            claim.claimLines.forEach((line, index) => {
                ...
                this.addSegment([
                    ...
                    (0, utils_1.formatEDIAmount)(line.charge || 0),
                    "UN", // Units qualifier
                ...
                const serviceDateStr = (0, utils_1.formatEDIDate)(serviceDate);
...
exports.EDI837Generator = EDI837Generator;
